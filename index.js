...
<head>
    ...
    <meta property='description content="Uploaded: ${parsedfileinfo.date} Size: ${parsedfileinfo.size / 1000} Duration: ${parsedfileinfo.duration / 1000}"/>
    <meta property='og:description content="Uploaded: ${parsedfileinfo.date} Size: ${parsedfileinfo.size / 1000} Duration: ${parsedfileinfo.duration / 1000}"/>
